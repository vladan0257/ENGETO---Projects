"""
bullsAndCows_0.3.py: třetí verze druhého projektu do Engeto Online Python Akademie
...
def generateNo(digitsLength=4):
    ...
    if secretNo[0] == 0: secretNo[0] = random.choice([no for no in numbersPool if no not in secretNo])
